function mode = BasicUID_StandingState(HipMeanAngle,HipDiffAngle,HipStdAngle,HipStdAngleSign,Alpha,AlphaDot,Beta,HipStdDiffAngle,ConThres)
global ExoP;
...
elseif ExoP.UID.AngleInfoFlag ...
       ...
       && HipStdAngle > ExoP.UID.HipStdAngle_Thre(3) && HipStdAngleSign > 0) ...
...
elseif ~ExoP.UID.AngleInfoFlag ...
        ...
        || Alpha > (1+ExoP.UID.RatioTol(1))*ExoP.UID.Alpha_Thre(1))
    mode(1,1) = ExoP.StateTrans;
    mode(1,2) = ExoP.Lowering;
